...
annotatedfigure <- ggpubr::annotate_figure(arrangedfigure,
                                           top = ggpubr::text_grob("Equal scale parameter                   scale parameter +100", 
                                                                   face = "bold", size = 10), 
                                           left = ggpubr::text_grob("SD = 3           SD = 0", face = "bold", size = 10, rot = 90))

png("C:Users/Joukje/Documents/GitHub/ResearchRepository/2.Plots/AnnotatedPlot.png", width = 10, height = 10)
