---
title: "2.2.PoolingTestThenPool"
author: "Joukje Willemsen"
date: "20 februari 2020"
output: html_document
---

In  this document the decision to pool or not is determined by a regular TTP test for the scenarios referred to as A, B, E1-3 and F1-3 in the article.
...
#Save the matrices
save(pvaluematrices, file = "2.PoolingMethods_output/2.2.PvaluesTTPShape.Rdata")
```
