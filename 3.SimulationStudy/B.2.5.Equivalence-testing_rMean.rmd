...
In this document the confidence intervals of the RMST test are calculated for the scenarios referred to as A, B, E1-3 and F1-3 in the article.
...
#Save CIs
```{r}
save(CIsRMEAN, file = "2.PoolingMethods_output/2.5.CIsRMEAN3Shape.Rdata")
```
