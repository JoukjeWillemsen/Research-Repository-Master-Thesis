...
In this document the TPR/FPR plots are created for every poolingmethod and every decisionthreshold in every simulated scenario, referred to as A, B, E1-3 and F1-3 in the article.
...
#saveplot
ggsave("4.DataVisualization_output/1.Sim2.png", plot = annotatedfigureBOTH, width = 20, height = 10)
```
