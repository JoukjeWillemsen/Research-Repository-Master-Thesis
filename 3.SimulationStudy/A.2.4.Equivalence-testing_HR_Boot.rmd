---
title: "2.4 HR equivalence boot"
author: "Joukje Willemsen"
date: "13-05-2020"
output: html_document
---

In this document the confidence intervals of the HR test are bootstrapped for the scenarios referred to as A, B, C1-3 and D1-3 in the article.
...
#Function that returns a matrix with all the CI's
```{r}
...
```{r}
save(BootCIsHR, file = "2.PoolingMethods_output/2.4.BootCIsHR.Rdata")
```
