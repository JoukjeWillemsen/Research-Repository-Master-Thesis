...
In this document the confidence intervals of the RMST test are bootstrapped for the scenarios referred to as A, B, C1-3 and D1-3 in the article.
...
#Save CIs
```{r}
save(BootCIsRMEAN, file = "2.PoolingMethods_output/2.6.Boot_CIsRMEANSNEL.Rdata")
```
